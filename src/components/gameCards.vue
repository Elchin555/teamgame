...
export default {
  ...
  data() {
    return {
      ...
      answer: {},
      cards: [
        { id: "1", component: "card", image: "/src/assets/card-1.jpg",name:"Ahmed" },
        { id: "2", component: "card", image: "/src/assets/card-2.jpg",name:"Aydan" },
        { id: "3", component: "card", image: "/src/assets/card-3.jpg",name:"Simran" },
        { id: "4", component: "card", image: "/src/assets/card-4.jpg",name:"Amir" },
        { id: "5", component: "card", image: "/src/assets/card-5.jpg",name:"Asgar" },
        { id: "6", component: "card", image: "/src/assets/card-6.jpg" ,name:"Azad"},
        { id: "7", component: "card", image: "/src/assets/card-7.jpg",name:"Elchin" },
        { id: "8", component: "card", image: "/src/assets/card-8.jpg",name:"Farman" },
        { id: "9", component: "card", image: "/src/assets/card-9.jpg",name:"Ruhin" },
      ],
    };
  },
  created() {
